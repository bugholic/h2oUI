      ...
      <section className="md:grid gap-10 grid-flow-col grid-cols-3 md:my-10 text-white">
        ...
        <div className="text-white md:col-span-2 md:grid grid-flow-col grid-rows-3 gap-2">
          ...
          <div className="leading-normal">
            <div className="my-5 font-semibold w-3/4">Bromine Br</div>
          ...
          <div className="leading-normal">
            <div className="my-5 font-semibold w-3/4">Calcium Ca++</div>
            <p className="font-light">
          ...
          <div className="leading-normal">
            <div className="my-5 font-semibold w-3/4">Sodium Na+</div>
            <p className="font-light">
          ...
          <div className="leading-normal">
            <div className="my-5 font-semibold w-3/4"> Magnesium Mg2+</div>
            <p className="font-light">
          ...
          <div className="leading-normal">
            <div className="my-5 font-semibold w-3/4"> Potassium K+</div>
            <p className="font-light">
